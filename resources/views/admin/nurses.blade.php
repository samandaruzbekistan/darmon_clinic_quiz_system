            ...
            <div class="dash-content">
                <div class="overview">
                    <div class="title">
                        ...
                        <span class="text" id="glavni">Hamshiralar ro'yhati</span>
                    </div>
                    <button id="bu" class="btn" onclick="formOpen()">Yangi hamshira qo'shish <i class="fas fa-rectangle-history-circle-plus"></i></button>
                    <form action="{{ route('new_nurse_reg') }}" class="form-style-2" method="post" id="form-style" style="display: none">
                        @csrf
        ...
        @else
            <div class="dash-content">
                <div class="overview">
                    <div class="title">
                        <i class="fas fa-user-md"></i>
                        <span class="text" id="glavni">Hamshiralar hali kiritilmagan!</span>
                    </div>
                    <button id="bu" class="btn" onclick="formOpen()">Yangi hamshira qo'shish <i class="fas fa-rectangle-history-circle-plus"></i></button>
                    <form action="{{ route('new_nurse_reg') }}" class="form-style-2" method="post" id="form-style" style="display: none">
                        @csrf
