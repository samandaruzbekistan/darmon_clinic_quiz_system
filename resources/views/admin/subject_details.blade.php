        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <div class="fan_cards" id="fan-cards">
                    ...
                    <div class="detail_card border-left-success">
                        <div class="card-body">
                            <div class="align-items-center no-gutters">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        Nechta chiqishi</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $subject->count }} ta</div>
                                </div>
                                <div class="col-auto">
                    ...
                    <div class="detail_card border-left-info">
                        <div class="card-body">
                            <div class="align-items-center no-gutters">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                        Berilgan vaqt</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $subject->time }} daqiqa</div>
                                </div>
                                <div class="col-auto">
                    ...
                    <div class="detail_card border-left-warning">
                        <div class="card-body">
                            <div class="align-items-center no-gutters">
                                <div class="col mr-2">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $subject->prosent }}%</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto">
                    ...
                    <button class="detail_card border-left-danger" onclick="trash()">
                        <div class="card-body">
                            <div class="align-items-center">
                                <div class="col">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><i class="fas fa-trash" style="color: red"></i></div>
                                </div>
                            </div>
                        </div>
                    </button>
                ...
                <div class="form-style-2" id="form-edit" style="display: none">
                    <div class="info">
                        <form action="{{ route('subject_update') }}" method="post">
                            @csrf
                ...
                <div class="form-style-2" id="form-style" style="display: none">
                    <div class="info">
                        <form action="{{ route('new_quiz_reg') }}" method="post" enctype="multipart/form-data">
                            @csrf
                        ...
                        @foreach ($quizzes as $id => $item)
                            <tr>
                                ...
                                @foreach($answers[$id] as $i => $answer)
                                    ...
                                    @endif
                                @endforeach
                                <td style="text-align: center; vertical-align: center"><a class="btn" href="{{ route('quiz_edit', ['id' => $item->id]) }}"><i class="fa fa-edit"></i></a></td>
                                <td style="text-align: center; vertical-align: top">
                                    <form action="{{ route('delete_quiz') }}" method="POST">
                                        @csrf
